...
#p6Driver.py, Written by William Lippard
...
if sysLen < 2 :
    print("ERROR: Correct fileName  needed as command argument. Usage: python3 p6Driver.py fileNameName.txt")
    sys.exit(1)
...
print("BEEP source code in ", sys.argv[1], ":", sep="")
